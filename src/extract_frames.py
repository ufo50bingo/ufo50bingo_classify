...
VIDEO_LIST = [
    ...
    # trim
    ("https://www.youtube.com/watch?v=3MHi9SnkT6g", "kickclub", "boy"),
    ("https://www.youtube.com/watch?v=fcZ-8tz5aM0", "kickclub", "girl"),
    ...
    ("https://www.youtube.com/watch?v=Qlux9aPCwBM", "fisthell", "jay"),
    ("https://www.youtube.com/watch?v=qh1EYLUXbWM", "fisthell", "cat"),
    ("https://www.youtube.com/watch?v=XJ2YjozthTc", "fisthell", "victor"),
    ("https://www.youtube.com/watch?v=HEADmWR9c_o", "fisthell", "amy"),
    ("https://www.youtube.com/watch?v=DiypNQGxEUs", "fisthell", "gym"),
...
def extract_frames(video_path, output_dir, fps_extract, target_size, extra):
    """
    ...
    while True:
        ...
        if frame_count % frame_interval == 0:
            ...
            frame_filename = os.path.join(
                output_dir,
                f"{extra + '_' if extra != '' else ''}frame_{saved_count:05d}.png",
            )
...
# -----------------------------
def main():
    for url, game_name, extra in VIDEO_LIST:
        video_save_path = os.path.join(
            VIDEOS_DIR, f"{game_name}{'_' + extra if extra != '' else ''}.mp4"
        )
